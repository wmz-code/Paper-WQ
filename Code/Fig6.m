...
for jj=1:8 
    ...
    for mm=1:5
        path1=strcat(['D:\Home\Data\Fig6\pred_ssp126cli_nonlinear_gcm',num2str(mm),'.xlsx']);
        path3=strcat(['D:\Home\Data\Fig6\pred_ssp370cli_nonlinear_gcm',num2str(mm),'.xlsx']);
        path5=strcat(['D:\Home\Data\Fig6\pred_ssp585cli_nonlinear_gcm',num2str(mm),'.xlsx']);
