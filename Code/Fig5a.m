...
for jj=1:8 
    ...
    for mm=1:5 
        ...
        path1=strcat(['D:\China\pre_ssp126cn_bayesrandom_nonlinear_gcm',num2str(mm),'.xlsx']);
        path3=strcat(['D:\China\pre_ssp370cn_bayesrandom_nonlinear_gcm',num2str(mm),'.xlsx']);
        path5=strcat(['D:\China\pre_ssp585cn_bayesrandom_nonlinear_gcm',num2str(mm),'.xlsx']);
...
% print -dpdf -r600 -painters Fig5a
