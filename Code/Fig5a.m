...
for jj=1:8 
    ...
    for mm=1:5 
        ...
        path1=strcat(['D:\Home\Data\Fig5\GCM',num2str(mm),'\China\','pred_ssp126cn_nonlinear.xlsx']);
        path3=strcat(['D:\Home\Data\Fig5\GCM',num2str(mm),'\China\','pred_ssp370cn_nonlinear.xlsx']);
        path5=strcat(['D:\Home\Data\Fig5\GCM',num2str(mm),'\China\','pred_ssp585cn_nonlinear.xlsx']);
